...
# Parámetros
# ========================================
file_in = "/home/manue/compu-workspace/p2/temp=25.txt" # Nombre del fichero de datos
file_out = "./Modelo_Ising/videos/ising_T0005_ta_N800_ite60" # Nombre del fichero de salida (sin extensión)
